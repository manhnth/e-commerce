  ...
  return (
    <Container>
      <div className="mt-10 flex gap-1">
        ...
        <ArrowRight />
        <Link className="hover:text-blue-500" href={`/search/?q=${category}`}>
          {category}
        </Link>
      </div>
      <div className="mt-6 justify-center md:flex md:gap-6 lg:h-96 lg:grid-cols-2 lg:gap-16">
        <div className="max-w-xl rounded-sm border border-gray-300 px-10">
